# reservation-domain-events Specification

## Purpose
ReservationCreatedEvent (full snapshot with items), ReservationCancelledEvent (with failure messages), ReservationItemSnapshot record — all implementing DomainEvent interface from common.
